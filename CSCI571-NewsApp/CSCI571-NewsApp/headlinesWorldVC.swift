...
class headlinesWorldVC: UIViewController, IndicatorInfoProvider, UITableViewDelegate,  UITableViewDataSource, tableCellDelegate{
    ...
    let spinnerMessage = "Loading WORLD Headlines.."
    let indicatorInfo = "WORLD"
    var allNews = [newsCard]()
    var newsImages = [UIImage]()
    let homeBackendUrl = "http://myiosnewsappbackend.us-east-1.elasticbeanstalk.com/world"
