...
class headlinesScienceVC: UIViewController, IndicatorInfoProvider, UITableViewDelegate,  UITableViewDataSource, tableCellDelegate{
    ...
    let spinnerMessage = "Loading SCIENCE Headlines.."
    let indicatorInfo = "SCIENCE"
    var allNews = [newsCard]()
    var newsImages = [UIImage]()
    let homeBackendUrl = "http://myiosnewsappbackend.us-east-1.elasticbeanstalk.com/science"
