...
class headlinesPoliticsVC: UIViewController, IndicatorInfoProvider, UITableViewDelegate,  UITableViewDataSource, tableCellDelegate{
    ...
    let spinnerMessage = "Loading POLITICS Headlines.."
    let indicatorInfo = "POLITICS"
    var allNews = [newsCard]()
    var newsImages = [UIImage]()
    let homeBackendUrl = "http://myiosnewsappbackend.us-east-1.elasticbeanstalk.com/politics"
