...
class headlinesTechnologyVC: UIViewController, IndicatorInfoProvider, UITableViewDelegate,  UITableViewDataSource, tableCellDelegate{
    ...
    let spinnerMessage = "Loading TECHNOLOGY Headlines.."
    let indicatorInfo = "TECHNOLOGY"
    var allNews = [newsCard]()
    var newsImages = [UIImage]()
    let homeBackendUrl = "http://myiosnewsappbackend.us-east-1.elasticbeanstalk.com/technology"
