...
class headlinesSportVC: UIViewController, IndicatorInfoProvider, UITableViewDelegate,  UITableViewDataSource, tableCellDelegate{
    ...
    let spinnerMessage = "Loading SPORTS Headlines.."
    let indicatorInfo = "SPORTS"
    var allNews = [newsCard]()
    var newsImages = [UIImage]()
    let homeBackendUrl = "http://myiosnewsappbackend.us-east-1.elasticbeanstalk.com/sport"
